...
exports.GraphApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getSemanticGraphV1GraphSemanticGraphGet: (topic1, topic2, ids1, ids2, minStrength, minCount, options = {}) => __awaiter(this, void 0, void 0, function* () {
         ...
         * @throws {RequiredError}
         */
        getSemanticTopicGraphV1GraphSemanticTopicGraphPost: (semanticTopicGraphIn, options = {}) => __awaiter(this, void 0, void 0, function* () {
         ...
         * @throws {RequiredError}
         */
        getTopicGraphV1GraphTopicGraphGet: (numRelationships, options = {}) => __awaiter(this, void 0, void 0, function* () {
...
exports.GraphApiFp = function (configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getSemanticGraphV1GraphSemanticGraphGet(topic1, topic2, ids1, ids2, minStrength, minCount, options) {
            return __awaiter(this, void 0, void 0, function* () {
                const localVarAxiosArgs = yield localVarAxiosParamCreator.getSemanticGraphV1GraphSemanticGraphGet(topic1, topic2, ids1, ids2, minStrength, minCount, options);
                return common_1.createRequestFunction(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration);
            });
        },
        /**
         ...
         * @throws {RequiredError}
         */
        getSemanticTopicGraphV1GraphSemanticTopicGraphPost(semanticTopicGraphIn, options) {
            return __awaiter(this, void 0, void 0, function* () {
                const localVarAxiosArgs = yield localVarAxiosParamCreator.getSemanticTopicGraphV1GraphSemanticTopicGraphPost(semanticTopicGraphIn, options);
                return common_1.createRequestFunction(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration);
            });
        },
        /**
         ...
         * @throws {RequiredError}
         */
        getTopicGraphV1GraphTopicGraphGet(numRelationships, options) {
            return __awaiter(this, void 0, void 0, function* () {
                const localVarAxiosArgs = yield localVarAxiosParamCreator.getTopicGraphV1GraphTopicGraphGet(numRelationships, options);
                return common_1.createRequestFunction(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration);
            });
        },
        /**
...
class GraphApi extends base_1.BaseAPI {
    ...
    getSemanticGraphV1GraphSemanticGraphGet(requestParameters = {}, options) {
        return exports.GraphApiFp(this.configuration).getSemanticGraphV1GraphSemanticGraphGet(requestParameters.topic1, requestParameters.topic2, requestParameters.ids1, requestParameters.ids2, requestParameters.minStrength, requestParameters.minCount, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Fetch single topic semantic graph.
     * @summary Get Semantic Topic Graph
    ...
    getSemanticTopicGraphV1GraphSemanticTopicGraphPost(requestParameters, options) {
        return exports.GraphApiFp(this.configuration).getSemanticTopicGraphV1GraphSemanticTopicGraphPost(requestParameters.semanticTopicGraphIn, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Fetch topic graph.
     * @summary Get Topic Graph
    ...
    getTopicGraphV1GraphTopicGraphGet(requestParameters = {}, options) {
        return exports.GraphApiFp(this.configuration).getTopicGraphV1GraphTopicGraphGet(requestParameters.numRelationships, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Fetch topic node graph.
     * @summary Get Topic Node Graph
